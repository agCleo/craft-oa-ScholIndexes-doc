...
| **Access for index data providers** | Subscription fees dependant of the kinds of community participation (annual membership fees and content registration fees for members, optional member fees for Similarity Check, and annual subscription fees for Metadata Plus). See full description: <br> https://www.crossref.org/fees/#annual-membership-fees |
